...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent/jahied/LOVE-09/Apruve.txt/main/Apruve.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent/jahied/LOVE-09/Apruve.txt/main/Apruve.txt').text
			if basesplit in plr:
				key = basesplit
