...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR RAKIB-BD JAHIED\x1b[0m\x1b[1;97m]
...
def logo2():
 ...
 |  _ <| |      / /\ \| |    |  <           
 | |_) | |____ / ____ \ |____| . \          
 |____/|______/_/   _\_\_____|_|\_\_ _____  
 | |  | | |  | | \ | |__   __|  ____|  __ \ 
 | |__| | |  | |  \| |  | |  | |__  | |__) |
 |  __  | |  | | . ` |  | |  |  __| |  _  / 
 | |  | | |__| | |\  |  | |  | |____| | \ \ 
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent/jahied/LOVE-09/Apruve.txt/blob/main/Apruve.txt"])
...
def notice():
	...
	runtxt("\n\033[0;97m  Free 2009 cloning Tool For Aproval Join Group ")
	os.system("xdg-open https://chat.whatsapp.com/FK5mDR4T2By4KxLwRyhzjx/?app=fbl")
	runtxt("\033[0;97m Key Approval ke Group Jion Karo >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key group admin ke post pe coment karo")
	os.system("xdg-open https://chat.whatsapp.com/FK5mDR4T2By4KxLwRyhzjx/?app=fbl")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent/jahied/LOVE-09/Apruve.txt/blob/main/Apruve.txt').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCzpqRlRaLASqwsWvsPuCdwQ"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s(B-H-T)"%(G,R,G,Y,B))
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : HAR 10 MIN BAD AIRPLAN MOD/FLIGHT MOD ON KARO ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
